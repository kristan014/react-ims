...
export class DataTableComponent extends Component {
  constructor(props) {
    ...
    this.BootyCheckbox = React.forwardRef(({ onClick, ...rest }, ref) => (
    ...
    this.BootyPagination = ({
      ...
      this.handlePageNumber = (e) => {
        onChangePage(Number(e.target.value));
      };

      this.getNumberOfPages = (rowCount, rowsPerPage) => {
      ...
      this.pages = this.getNumberOfPages(rowCount, rowsPerPage);
      this.pageItems = this.toPages(this.pages);
      this.nextDisabled = this.currentPage === this.pageItems.length;
      this.previosDisabled = this.currentPage === 1;
          ...
          <ul className="pagination">
            <li className="page-item">
              <button
                ...
                disabled={this.previosDisabled}
                aria-disabled={this.previosDisabled}
                aria-label="previous page"
              >
                Previous
              </button>
            </li>
            {this.pageItems.map((page) => {
              const className =
  ...
  render() {
    return (
      <DataTable
        ...
        selectableRows
        // selectableRowsComponent={this.BootyCheckbox}
      />
    );
  }
}
